...
// Use this instead of ExampleTextToSpeech so you can choose languages besides english
public class CustomTextToSpeech : MonoBehaviour
{
    // extend with new languages as necessary
    ...
    public IEnumerator Convert(string text) {
        ...
        switch (language)
        {
            ...
            case TTSLanguage.Japanese:
                _service.Voice = VoiceType.ja_JP_Emi;
                break;
        }
